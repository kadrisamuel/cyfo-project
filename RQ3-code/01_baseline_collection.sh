...
# Capture state of all Bluetooth artifact locations before any
...
# System-level Bluetooth plist (legacy location)
...
# Primary artifact location (macOS 26)
...
# Library/Bluetooth directory inventory
...
# SyncedPreferences (iCloud sync channel)
...
# Anchor log position for later diff
...
# Hash all output files for chain of custody
